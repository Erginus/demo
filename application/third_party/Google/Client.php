...
require_once FCPATH . 'application/third_party/Google/Auth/AssertionCredentials.php';
require_once FCPATH . 'application/third_party/Google/Cache/File.php';
require_once FCPATH . 'application/third_party/Google/Cache/Memcache.php';
require_once FCPATH . 'application/third_party/Google/Config.php';
require_once FCPATH . 'application/third_party/Google/Collection.php';
require_once FCPATH . 'application/third_party/Google/Exception.php';
require_once FCPATH . 'application/third_party/Google/IO/Curl.php';
require_once FCPATH . 'application/third_party/Google/IO/Stream.php';
require_once FCPATH . 'application/third_party/Google/Model.php';
require_once FCPATH . 'application/third_party/Google/Service.php';
require_once FCPATH . 'application/third_party/Google/Service/Resource.php';
