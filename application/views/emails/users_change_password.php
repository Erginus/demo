...
Your account password is changed by site administrator. Following are the details.
<div style="padding: 12px;background-color: rgb(252,248,227); border-color: rgb(250,235,204);color: rgb(138,109,59);word-wrap:break-word;">
    New Password : <b><?php echo $user_login_password; ?></b>
</div>
<br/>
You might need to change your password when you log in using this password.<br/>
