<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1><?php echo $user['user_first_name'] . ' ' . $user['user_last_name']; ?> Permissions</h1>
            <hr class="colorgraph" />
        </div>
                            ...
                            <ul class="nav nav-pills">
                                ...
                                foreach ($urls as $url) {
                                    if ($url['url_sets_id'] === '0') {
                                        ?>
                                        <li>
                                            <label><input type="checkbox" value="1" class="url_permission" id="user_url_permission_<?php echo $url['url_id']; ?>" <?php
                                if ($url['user_url_permission'] === '1') {
                                ...
                                <ul class="nav nav-pills nav-stacked" id="url_set_<?php echo $url_set['url_set_id']; ?>">
                                    ...
                                    foreach ($urls as $url) {
                                        if ($url['url_sets_id'] === $url_set['url_set_id']) {
                                            ...
                                            <li>
                                                <label>
                                                    <input type="checkbox" value="1" class="url_permission" id="user_url_permission_<?php echo $url['url_id']; ?>" <?php
                                if ($url['user_url_permission'] === '1') {
                                    echo 'checked="checked"';
                                }
                                            ?> />
