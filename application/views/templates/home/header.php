            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="javascript:" onclick="$('#about').fadeIn();$('#features').hide();$('#author').hide();">About Me</a></li>
                        <li><a href="javascript:" onclick="$('#features').fadeIn();$('#about').hide();$('#author').hide();">Application Features</a></li>
                    </ul>
